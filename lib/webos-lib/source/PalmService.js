/**
	...
	Internally it generates new <a href="#weboslib.ServiceRequest">weboslib.ServiceRequest</a> for each `send()`
...
enyo.kind({
	...
	events: {
		/**
			...
			_inEvent.request_ contains the associated <a href="#weboslib.ServiceRequest">weboslib.ServiceRequest</a>
			instance.
	...
	/**
		...
		<a href="#weboslib.ServiceRequest">weboslib.ServiceRequest</a> instance.
	*/
